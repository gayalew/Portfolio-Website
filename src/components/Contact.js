                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
                     ...
                     <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        Get in touch today to discuss your project needs and start collaborating to make a noticable difference!
                     </p>
                     <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({href, icon}, index) => (
                           <a key={index} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"> {icon} </a>
                        ))}
                     </div>
                    
                </div>

                <form action="https://getform.io/f/aolmomjb" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Put Your Name" className="text-field reveal-up"></input>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="Put Your Email" className="text-field reveal-up"></input>
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <textarea name="message" id="message" required placeholder="Put Your Message" className="text-field resize-y min-h-32 max-h-80 reveal-up"></textarea>
                    </div>
